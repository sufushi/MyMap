...
public class MySearchHistoryAdapter extends BaseAdapter {
    ...
    public MySearchHistoryAdapter(List<String> searchHistoryList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_search_history_listview, null, false);
        ...
        viewHolder.textView.setText(mSearchHistoryList.get(position));
        return convertView;
    }
